    ...
    <div className="w-full min-h-screen bg-[#0B0F19] text-[#F1F5F9] relative flex flex-col">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-8 h-16 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="font-extrabold text-lg tracking-tight text-white font-serif">
                MitrAI <span className="text-emerald-400 font-light text-sm font-sans">(SafeSpeak)</span>
              </span>
            </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto space-y-4 text-center mb-8">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight drop-shadow-md font-serif">
      ...
      <div className="relative z-40 overflow-hidden border-t border-white/10">
        ...
        <section id="features" className="relative z-10 py-24 px-6 md:px-16">
          <div className="max-w-6xl mx-auto space-y-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Card 1: Crisis Breaker */}
              <div className="p-8 rounded-3xl bg-[#0c1812]/90 backdrop-blur-2xl border border-[#47624f]/40 hover:border-[#84cc9c]/70 transition-all shadow-[0_16px_50px_rgba(0,0,0,0.65)] group flex flex-col justify-between space-y-6">
              ...
              {/* Card 2: Emotion-Preserving NLP */}
              <div className="p-8 rounded-3xl bg-[#0c1812]/90 backdrop-blur-2xl border border-[#3f5e5b]/40 hover:border-[#73c7be]/70 transition-all shadow-[0_16px_50px_rgba(0,0,0,0.65)] group flex flex-col justify-between space-y-6">
                <div className="space-y-4">
              ...
              {/* Card 3: RAM Session Dissolve */}
              <div className="p-8 rounded-3xl bg-[#0c1812]/90 backdrop-blur-2xl border border-[#6b4728]/40 hover:border-[#e09f67]/70 transition-all shadow-[0_16px_50px_rgba(0,0,0,0.65)] group flex flex-col justify-between space-y-6">
                <div className="space-y-4">
        ...
        <section id="helplines" className="relative z-10 py-20 px-6 md:px-16 border-t border-white/10">
          <div className="max-w-5xl mx-auto space-y-10">
            <div className="text-center space-y-3">
              <span className="text-xs uppercase tracking-widest text-red-300 font-serif font-bold bg-red-950/70 border border-red-500/40 px-4 py-1.5 rounded-full inline-block backdrop-blur-md shadow-sm">
                Emergency Safety Network
              </span>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-[#faf7f2] drop-shadow-md font-serif">
                Instant National Support Helplines
              </h2>
              <p className="text-[#c2d1bd] text-sm max-w-xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {/* Helpline 1 */}
              <div className="p-6 rounded-3xl bg-gradient-to-b from-red-950/80 via-[#0c1812]/95 to-[#0c1812]/95 border border-red-500/50 space-y-4 shadow-[0_12px_36px_rgba(239,68,68,0.2)] backdrop-blur-xl">
                <div>
                  <span className="text-[10px] px-2.5 py-0.5 rounded-full bg-red-500 text-white font-bold uppercase shadow-sm">
                    National Primary
                  </span>
                  <h3 className="text-lg font-serif font-bold text-white mt-2">Tele-MANAS</h3>
                  <p className="text-xs text-[#c2d1bd] mt-1">Govt. of India 24/7 Mental Health Helpline (20+ Languages)</p>
                </div>
                <div className="text-3xl font-mono font-extrabold text-red-400">14416</div>
                <a
                  href="tel:14416"
                  className="w-full py-3 rounded-2xl bg-red-600 hover:bg-red-500 text-white text-xs font-serif font-bold flex items-center justify-center gap-2 shadow-lg shadow-red-600/40 transition-all cursor-pointer"
                >
              ...
              {/* Helpline 2 */}
              <div className="p-6 rounded-3xl bg-[#0c1812]/90 border border-[#47624f]/35 space-y-4 shadow-xl backdrop-blur-xl">
                <div>
                  <span className="text-[10px] px-2.5 py-0.5 rounded-full bg-[#1b2e22] text-[#c2d1bd] font-bold uppercase border border-[#47624f]/40">
                    Toll-Free 24/7
                  </span>
                  <h3 className="text-lg font-serif font-bold text-white mt-2">KIRAN Helpline</h3>
                  <p className="text-xs text-[#c2d1bd] mt-1">Depression, Anxiety & Crisis Intervention Hotline</p>
                </div>
                <div className="text-2xl font-mono font-bold text-[#faf7f2]">1800-599-0019</div>
                <a
                  href="tel:18005990019"
                  className="w-full py-3 rounded-2xl bg-[#1b2e22] hover:bg-[#253d2e] text-[#faf7f2] text-xs font-serif font-bold flex items-center justify-center gap-2 border border-[#47624f]/50 transition-all cursor-pointer shadow-sm"
                >
                  <PhoneCall className="w-4 h-4" />
              ...
              <div className="p-6 rounded-3xl bg-[#0c1812]/90 border border-[#47624f]/35 space-y-4 shadow-xl backdrop-blur-xl">
                <div>
                  ...
                  <h3 className="text-lg font-serif font-bold text-white mt-2">Vandrevala Foundation</h3>
                  <p className="text-xs text-[#c2d1bd] mt-1">Free 24/7 Mental Health Counseling Support</p>
                </div>
                <div className="text-2xl font-mono font-bold text-[#faf7f2]">+91 9999 666 555</div>
                <a
        ...
        {/* ── 3C. Footer ── */}
        <footer className="relative z-10 py-8 text-center text-xs text-[#95a88d] border-t border-[#47624f]/25">
          <div className="max-w-6xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              <Shield className="w-4 h-4 text-[#84cc9c]" />
              <span className="font-serif font-bold text-[#faf7f2]">MitrAI (SafeSpeak)</span>
              <span>— Real-time Indic Peer Support & Crisis Shield</span>
            </div>
            <div className="flex items-center gap-4 text-[#b5c7b0]">
              <span>Zero DB Persistence</span>
              <span>•</span>
              <span>DPDP / HIPAA Compliant Blueprint</span>
              <span>•</span>
              <span className="text-[#84cc9c] font-semibold">RAM Ephemeral</span>
            </div>
          </div>
        </footer>
      </div>
