...
export const ProductLanding: React.FC<ProductLandingProps> = ({
  ...
  return (
    <div className="w-full min-h-screen bg-[#0B0F19] text-[#F1F5F9] relative flex flex-col">
      ...
      <section id="features" className="relative z-40 bg-[#070a12] py-24 px-6 md:px-16 border-t border-white/10">
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Card 1 */}
            <div className="p-8 rounded-3xl bg-slate-900/60 border border-white/10 hover:border-emerald-500/50 transition-all group flex flex-col justify-between space-y-6">
            ...
            {/* Card 2 */}
            <div className="p-8 rounded-3xl bg-slate-900/60 border border-white/10 hover:border-teal-500/50 transition-all group flex flex-col justify-between space-y-6">
              <div className="space-y-4">
            ...
            {/* Card 3 */}
            <div className="p-8 rounded-3xl bg-slate-900/60 border border-white/10 hover:border-red-500/50 transition-all group flex flex-col justify-between space-y-6">
              <div className="space-y-4">
      ...
      {/* ── 4. 24/7 Verified Crisis Helpline Directory ── */}
      <section id="helplines" className="relative z-40 bg-[#0B0F19] py-20 px-6 md:px-16 border-t border-white/10">
        <div className="max-w-5xl mx-auto space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {/* Helpline 1 */}
            <div className="p-6 rounded-2xl bg-gradient-to-b from-red-500/10 to-slate-900 border border-red-500/40 space-y-4">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">Govt. of India 24/7 Mental Health Helpline (20+ Languages)</p>
              </div>
              <div className="text-2xl font-mono font-extrabold text-red-400">14416</div>
              <a
                href="tel:14416"
                className="w-full py-2.5 rounded-xl bg-red-500 hover:bg-red-600 text-white text-xs font-bold flex items-center justify-center gap-2 shadow-lg shadow-red-500/30 transition-all cursor-pointer"
              >
            ...
            <div className="p-6 rounded-2xl bg-slate-900/80 border border-white/10 space-y-4">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">Depression, Anxiety & Crisis Intervention Hotline</p>
              </div>
              <div className="text-xl font-mono font-bold text-slate-200">1800-599-0019</div>
              <a
                href="tel:18005990019"
                className="w-full py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-white text-xs font-bold flex items-center justify-center gap-2 border border-white/10 transition-all cursor-pointer"
              >
                <PhoneCall className="w-3.5 h-3.5" />
            ...
            <div className="p-6 rounded-2xl bg-slate-900/80 border border-white/10 space-y-4">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">Free 24/7 Mental Health Counseling Support</p>
              </div>
              <div className="text-xl font-mono font-bold text-slate-200">+91 9999 666 555</div>
              <a
      ...
      {/* ── Footer ── */}
      <footer className="relative z-40 bg-[#070a12] py-8 text-center text-xs text-slate-500 border-t border-white/5">
        <div className="max-w-6xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <Shield className="w-4 h-4 text-emerald-400" />
            <span className="font-semibold text-slate-300">MitrAI (SafeSpeak)</span>
